...
<html>
    ...
    <body>
        ...
        <div class="container" >
            ...
            <div class="col-md-12">
                <h1 id="pageTitle">Administration Home</h1>
                <hr/>

                <br><br> <br>
                <p>Admin Portal for All your Page needs</p> 
                <p>We need to have checks here to ensure that pages are as expected ? That data is up to date ?</p>
            </div>
        </div>
