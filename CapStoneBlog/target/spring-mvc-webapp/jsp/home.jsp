...
<html>
    <head>
        <title>Pat's Party Pavilion</title>
        <!-- Bootstrap core CSS -->
    ...
    <body>
        <nav class="navbar navbar-inverse navbar-static-top">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                    <c:forEach items="${homeSite.links}" var="link">
                        <c:choose>
        ...
        <div class="container">
            <h1 id="pageTitle"><c:out value="${homeSite.siteData.content}"/></h1>
            <hr/>
            ...
            <div class="col-md-12">
                <div class="col-md-7">
                    ...
                    <c:forEach var="currentBlog" items="${homeSite.blogList}">
                ...
                <div class="col-md-5" id="rightBigDiv">
                    ...
                    <c:forEach var="currentHashtag" items="${homeSite.hashTags}">
                        <div>
