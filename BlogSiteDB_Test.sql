...
(5, "ThatKidYouLove", "Rob", "Kacic", true, "$2a$10$DCIk1ZeP5/DU1Za5InnnpO3vp6OHAXQIjT1Ydlt7eDMn0B8X8LDRq");
...
('TokyoJ', 'ROLE_MANAGER'),
('TokyoJ', 'ROLE_USER'),
('ThatKidYouLove', 'ROLE_ADMIN'),
('ThatKidYouLove', 'ROLE_MANAGER'),
('ThatKidYouLove', 'ROLE_USER');
...
(4, "New Vape", "A man's best friend. What kind of dogs I like.", "2017/06/03", null, null, 4, 4, 5),
